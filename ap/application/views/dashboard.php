...
/*                position: relative;*/
    ...
    <body style="background-color: #243F54;font-family: Raleway;">
        <?php $this->load->view('templates/navbar'); ?>
        <div>
            <div id="dashboard-content" class="col-md-12" style="padding:0;">
                <?php $this->load->view('templates/sidebar'); ?>
<!--                <div id="working-pane" class="col-md-9" style="background-color:#243F54;min-height: 100vh;position: absolute;top: 55px;left: 180px;padding-bottom: 50px">-->
